class VisualizerSystem {
	...
	if(!this.ctx) throw new Error("ctx is undefined in visualizer system");
	if(!this.analyser) throw new Error("analyser is undeinfed in visualizer system");
	...
	if(!this.ctx) throw new Error("ctx is undefined in visualizer system");
	if(!this.canvas) throw new Error("canvas is undefined in visualizer system");
	if(!this.bufferLength) throw new Error("bufferLenth is undefined in visualizer system");
	if(!this.dataArray) throw new Error("dataArray is undefined in visualizer system");
